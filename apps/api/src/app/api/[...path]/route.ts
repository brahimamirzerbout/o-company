...
const TABLE: Record<string, keyof typeof routes> = {
  ...
  "GET  /api/operator/drafts":       "listOperatorDrafts",
  "GET  /api/operator/stats":        "operatorStats",
  "POST /api/operator/tick":         "tickOperator",
  "GET  /api/brief":                 "getBrief",
...
const ID_TAIL: Record<string, { method: string; handler: keyof typeof routes }> = {
  ...
  "GET  /api/contacts/:id/timeline":  { method: "GET",    handler: "GET_contact_timeline" },
  "GET  /api/contacts/:id/timeline/stream":  { method: "GET",    handler: "GET_contact_timeline_stream" },
  "GET  /api/crm/deals/insights":     { method: "GET",    handler: "GET_deal_insights" },
  "POST /api/crm/contacts/bulk-update": { method: "POST", handler: "POST_contacts_bulk_update" },
  "POST /api/crm/contacts/bulk-delete": { method: "POST", handler: "POST_contacts_bulk_delete" },
  "POST /api/crm/deals/bulk-update":    { method: "POST", handler: "POST_deals_bulk_update" },
  "GET  /api/crm/contacts/export.csv":  { method: "GET",    handler: "GET_contacts_export_csv" },
  "GET  /api/crm/contacts/export.json": { method: "GET",    handler: "GET_contacts_export_json" },
  "GET  /api/crm/deals/export.csv":     { method: "GET",    handler: "GET_deals_export_csv" },
  "GET  /api/crm/deals/export.json":    { method: "GET",    handler: "GET_deals_export_json" },
  ...
  "POST /api/brief/entry/:id/read":   { method: "POST", handler: "markRead" },
  "POST /api/brief/entry/:id/archive": { method: "POST", handler: "archiveEntry" },
};
